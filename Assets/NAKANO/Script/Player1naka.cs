...
public class Player1naka : MonoBehaviour
{
    ...
    public static float PlayerSPAttack = 2;//必殺技使用回数
    public static float PlayerSPAttackSub = 2;//必殺技使用回数保管用
    ...
    void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.gameObject.tag == "Enemy")
        {
            ...
            {
                SP1 = false;
                enemy.EnemyHP -= 2 * PlayerPower;//←必殺技は現在の攻撃力の2倍の攻撃をする

                if (enemy.EnemyHP < 0)
                {
                    enemy.EnemyHP -= enemy.EnemyHP;
                }
                Debug.Log("<color=blue>★</color>" + 2 * PlayerPower + "のダメージを与えた");
        ...
        if (collision.gameObject.tag == "Enemy3")
        {
            ...
            {
                SP1 = false;
                enemy3.EnemyHP3 -= 2 * PlayerPower;//必殺技威力調整プログラム
        ...
        if (collision.gameObject.tag == "EGhost")
        {
            ...
            {
                SP1 = false;
                enemyG.EnemyHPG -= 2 * PlayerPower;//必殺技威力調整プログラム
        ...
        if (collision.gameObject.tag == "LEnemy")
        {
            ...
            {
                SP1 = false;
                enemyL.EnemyHPL -= 2 * PlayerPower;//必殺技威力調整プログラム
        ...
        if (collision.gameObject.tag == "EDarkGhost")
        {
            ...
            {
                SP1 = false;
                enemyDarkG.EnemyHPDG -= 2 * PlayerPower;//必殺技威力調整プログラム
        ...
        if (collision.gameObject.tag == "EKnight")
        {
            ...
            {
                SP1 = false;
                enemyKnight.EnemyHPK -= 2*PlayerPower;//必殺技威力調整プログラム
        ...
        if (collision.gameObject.tag == "EGoblin")
        {
            ...
            {
                SP1 = false;
                enemyGoblin.EnemyHPGob -= 2 * PlayerPower;//必殺技威力調整プログラム
        ...
        if (collision.gameObject.tag == "EGoblin1")
        {
            ...
            {
                SP1 = false;
                enemyGoblin1.EnemyHPGob1 -= 2 * PlayerPower;//必殺技威力調整プログラム
        ...
        if (collision.gameObject.tag == "ETree")
        {
            ...
            {
                SP1 = false;
                enemyTree.EnemyHPT -= 2 * PlayerPower;//必殺技威力調整プログラム
        ...
        if (collision.gameObject.tag == "Boss")
        {
            ...
            {
                SP1 = false;
                boss.BossHP -= 2 * PlayerPower;//必殺技威力調整プログラム
